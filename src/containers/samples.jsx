...
//____________________2025/11/14________________
// Add SIS Election Voters — Controlled by Nomination Period
...
//   // ---------- Election Status Hook ----------
//   const { isNominationPeriod, status, loading } = useElectionStatus();

//   // ---------- Redirect when nomination period ends ----------
//   useEffect(() => {
//     if (loading) return;
//     if (status !== "nomination") {
//       navigate("/dashboard_A/rightButtonSec"); // redirect to main dashboard
//     }
...
//     try {
//       const res = await fetch("http://localhost:8000/api/addSisMember", {
//         method: "POST",
//         headers: {
//           "Content-Type": "application/json",
//         },
...
//       if (res.ok) {
//         console.log("✅ SIS Member Added");
//         resetForm();
//       } else {
//         console.error("❌ Failed to add SIS member");
//       }
//     } catch (err) {
...
//         className="flex flex-col items-center p-10 font-semibold text-black gap-6 w-1/2 rounded-lg shadow-lg bg-gradient-to-b from-emerald-950 to-emerald-100"
//       >
//         <h2 className="text-2xl text-white mb-4">Add SIS Voter</h2>
...
//           ) : isNominationPeriod ? (
//             <span className="text-green-300">Nomination period active ✅</span>
//           ) : (
//             <span className="text-red-400">Nomination ended — form disabled ⛔</span>
//           )}
//         </div>

//         {/* Student Name */}
//         <div className="flex flex-col w-full mb-5">
//           <label className="text-white text-lg mb-2 text-center">Student Name</label>
//           <input
//             type="text"
//             name="student_name"
//             value={data.student_name}
//             onChange={(e) => handleOnChange(e.target.name, e.target.value)}
//             className="h-12 text-center bg-slate-300 rounded-md p-2"
...
//         {/* Reg No */}
//         <div className="flex flex-col w-full mb-5">
//           <label className="text-white text-lg mb-2 text-center">Registration No</label>
//           <input
//             type="text"
//             name="reg_no"
//             value={data.reg_no}
...
//         {/* Email */}
//         <div className="flex flex-col w-full mb-5">
//           <label className="text-white text-lg mb-2 text-center">Email</label>
//           <input
//             type="email"
//             name="email"
//             value={data.email}
...
//         {/* Department */}
//         <div className="flex flex-col w-full mb-5">
//           <label className="text-white text-lg mb-2 text-center">Department</label>
//           <input
//             type="text"
//             name="department"
...
//         {/* Year */}
//         <div className="flex flex-col w-full mb-5">
//           <label className="text-white text-lg mb-2 text-center">Year</label>
//           <input
//             type="text"
//             name="year"
//             value={data.year}
...
//         <button
//           type="submit"
//           className={`mt-6 px-8 py-3 font-bold text-lg rounded-lg text-white ${
//             isNominationPeriod
//               ? "bg-orange-500 hover:bg-orange-600"
...
import React, { useEffect, useState } from "react";
import { useNavigate } from "react-router-dom";
import { useElectionStatus } from "../../hooks/useElectionStatus"; // your hook
...
const AddMembersSisElection = () => {
  ...
  // 🟢 MAIN UI (Visible only during nomination period)
  return (
    <div className="flex flex-col items-center justify-center p-10">

      {/* ⏰ SHOW TIME REMAINING */}
      {remainingTime && (
        <div className="mb-6 text-center text-lg font-bold text-orange-600 bg-white p-3 rounded-lg shadow-md">
      ...
      <form
        ...
        className="flex flex-col items-center p-10 font-semibold text-black gap-6 w-1/2 rounded-lg shadow-lg bg-gradient-to-b from-emerald-950 to-emerald-100"
      >
        {/* … rest of your AddMembersSisElection form … */}
      </form>
    </div>
  );
};
