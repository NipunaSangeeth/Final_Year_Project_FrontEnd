export { default as DBLeftSec_B } from "./DBLeftSec_B";
export { default as DBRightSec_B } from "./DBRightSec_B";
...
export { default as SisCandidateDetails } from "./SisCandidateDetails";
