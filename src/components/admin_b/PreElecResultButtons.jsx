...
// /**
//  * Parent page for "Previous Election Results".
//  * Contains tab navigation (president / sis) and an Outlet for child routes.
//  * Button "Back to Dashboard" navigates to '/admin-dashboard' (adjust if your route differs).
//  */
// const PreElecResult = () => {
//   const navigate = useNavigate();
...
//             ← Back to Dashboard
//           </button>
//           <h1 className="text-3xl font-bold text-white ml-1">
//             Election History
//           </h1>
//         </div>

//         {/* Keep a spacer or utility area */}
//         <div />
//       </div>
...
const PreElecResultButtons = () => {
  return (
    <div className="flex border-b border-gray-200 mb-6">
      ...
      >
        Previous President Elections
      </NavLink>
    </div>
  );
};

export default PreElecResultButtons;
