...
const DashboardGuidPopupAdmin_A = () => {
          ...
          >
            ...
            <div className="space-y-5 text-base leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-3 text-white/90 text-3xl">
                <li>
                  Add and manage <strong>Voters</strong> participating in each
                  election.
                </li>

                <li>
                  Review complete <strong>Voters details & profiles</strong> at
                  any time.
                </li>
              </ul>
            </div>
...
export default DashboardGuidPopupAdmin_A;
